...
public class CommonAMImpl extends ApplicationModuleImpl implements CommonAM {
        ...
        if (usersVO != null) {
            ...
            if (findByLoginCredentialsVC != null) {
                ...
                if (currentRow != null) {
                    ...
                    resultMap.put("EXPIRY_DAYS", (String)currentRow.getAttribute("WmsExpiryDays"));
     ...
     */
    public ViewObjectImpl getFWMSUsersUpdate() {
        return (ViewObjectImpl) findViewObject("FWMSUsersUpdate");
    }
}
