...
import com.ciobera.fwms.common.util.security.iFWMSJboException;
...
public class iFWMSUIErrorHandler {
    public static final ADFLogger logObject =
        ADFLogger.createADFLogger(iFWMSUIErrorHandler.class);

    public iFWMSUIErrorHandler() {
        super();
    }
    ...
    public String getMessage() {
        ...
        if (exception instanceof iFWMSJboException) {
            String errorCode = ((iFWMSJboException)exception).getErrorCode();
            String errorMsg = ((iFWMSJboException)exception).getMessage();
            ...
            return ADFUtil.getUIBundleMsg("ERR_DUP_TRANS"); //throw new JboException("TXN_NOT_COMPLETE");
                   ...
                   exception.getCause() instanceof iFWMSJboException) {
