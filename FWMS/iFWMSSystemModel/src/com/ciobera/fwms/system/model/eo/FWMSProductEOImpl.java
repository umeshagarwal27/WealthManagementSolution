...
public class FWMSProductEOImpl extends EntityImpl {
    ...
    protected void doDML(int operation, TransactionEvent e) {
        ...
        for(AttributeDef def:getEntityDef().getAttributeDefs()){
            ...
            if(seqName!=null){
                SequenceImpl a= new SequenceImpl(seqName,getDBTransaction());
     ...
     */
    public static Key createPrimaryKey(Number wmsProductId) {
    ...
    protected void create(AttributeList attributeList) {
        ...
        for(AttributeDef def:getEntityDef().getAttributeDefs()){
            String seqName=(String)def.getProperty("FWMS_PRODUCT_CREATE_SEQ");
            if(seqName!=null){
                SequenceImpl a= new SequenceImpl(seqName,getDBTransaction());
                oracle.jbo.domain.Number prodId = a.getSequenceNumber();
                System.out.println("The Seq Generated is "+prodId);
                populateAttribute(def.getIndex(), prodId);
                break;
            }
        }
    }
